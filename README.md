# Firmware for PicoMicro/MS with Master/Slave operation

## General
The PicoMicro/MS is intended for a replacement of an Arduino ProMicro. It is based on the PicoMicro[Hyperlink2PicoMicro] but has two additional connectors on board for setting up a chain.
